...
from Repthon import Repthon
from jepthon.core.loggerimport logging
...
ID_EDIT = gvarstatus("CUSTOM_ALIVE_TEXT") or "╮•⎚• مـعلومات الـشخص من بوت ريبثون"
JEP_EM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦"
JEP_EM = gvarstatus("CUSTOM_ALIVE_FONT") or "★•┉ ┉ ┉ ┉ ┉ 𝐑𝐄𝐏𝐓𝐇𝐎𝐍 ┉  ┉ ┉ ┉ ┉•★"
...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 5502537272 or user_id == 1145818344 or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  or user_id ==  else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id !=  and user_id != 5502537272 and user_id != 1145818344 else rotbat
    caption = f"<b> ✛━━━━━━━━━━━━━✛ </b>\n"
    caption += f"✛━━━━━━━━━━━━━✛ \n"
